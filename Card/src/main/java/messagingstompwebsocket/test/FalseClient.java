...
public class FalseClient {
    private final static Logger log = LoggerFactory.getLogger(FalseClient.class);

    public static String URL = "://localhost:8080";
    private String matchId;

    public static void main(String[] args) {
        FalseClient client = new FalseClient();


        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<String> response = restTemplate
                .postForEntity("http" + URL + Endpoint.MATCHMAKING_POST_JOIN + "/false", null, String.class);
