package com.blocker.cardgames.cardmap.bb.boardcardmap;
...
public final class BoardCardMap<C extends Card> extends CardMap<C, Optional<C>> {
    private final Map<C, Optional<C>> cards;

    public BoardCardMap(Map<C, Optional<C>> cards) {
        this.cards = cards;
    }
